...
export const EmergencyServicesPage = () => {
  ...
  useEffect(() => {
    ...
    // Requirement #15: Refresh nearby locations every 10 minutes (600,000 ms) without page reload
  ...
  // Filter facilities by active category & search query
  ...
  // Requirement #9: Nearest Emergency Facilities (Hospital, Police, Pharmacy, Fire)
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#0B0F17] text-slate-800 dark:text-slate-100 flex flex-col selection:bg-sky-600 selection:text-white">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        {isLocationDenied && (
          ...
          >
            ...
            <button
              ...
              className="px-3 py-1.5 bg-amber-600 hover:bg-amber-700 text-white rounded-xl font-bold flex items-center gap-1 shadow-xs shrink-0"
            >
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-1.5 pt-2 border-t border-slate-100 dark:border-slate-800">
                      ...
                      <button
                        ...
                        className="py-2 px-3 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 rounded-xl text-xs font-bold flex items-center justify-center gap-1 transition-all border border-slate-200 dark:border-slate-700"
                      >
        ...
        <section className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
          ...
          {/* Right / Bottom: Facilities Cards Grid */}
          <div className="lg:col-span-6 space-y-3">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-extrabold text-slate-900 dark:text-slate-100 flex items-center gap-2">
      ...
      <footer className="py-4 px-6 text-center text-xs text-slate-500 dark:text-slate-400 border-t border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shrink-0 mt-8">
        коपरगाव नगरपरिषद • 24/7 Smart City Emergency Operations Room • Toll-Free: 1800-233-1042
      </footer>
    </div>
  );
};
