    ...
    <div className="min-h-screen bg-slate-50 text-slate-800 flex flex-col justify-between selection:bg-orange-500 selection:text-white">
      ...
      <main className="flex-1 flex items-center justify-center p-4 py-12">
        <motion.div
          ...
          className="max-w-md w-full bg-white rounded-3xl p-8 border-t-4 border-t-orange-500 border-x border-b border-slate-200 shadow-xl shadow-slate-200/50"
        >
          <div className="text-center mb-8">
            <div className="w-14 h-14 mx-auto mb-4 bg-orange-50 rounded-2xl flex items-center justify-center text-orange-600 border border-orange-100">
            ...
            <h1 className="text-xl font-black text-slate-900 mb-1">नागरिक लॉगिन / Citizen Login</h1>
            <p className="text-xs text-slate-500 font-medium">Smart City Grievance Redressal & Services</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-3 pt-2">
              ...
              <button
                ...
                className="w-full py-3.5 px-4 bg-slate-100 hover:bg-slate-200 text-slate-800 border border-slate-300 font-bold rounded-xl transition-all text-sm uppercase tracking-wide"
              >
          ...
          <div className="mt-8 text-center pt-6 border-t border-slate-100 font-semibold text-xs">
